...
import Ed from "../Components/Home/Ed";
  ...
  {isOpen && (
    <Navbar key="navbar" />
        ...
        <section className="mb-16 my-auto">
          ...
          <h1 className="text-[28px]  lg:text-[28px] font-bold text-[#a1a0a633] mb-4">
            About me{" "}
          </h1>
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-2/3">
              <p className="text-lg text-[#ececec]leading-relaxed mb-4">
                I&apos;m a determined and curious individual with a drive to
                make a meaningful impact through my work. My journey combines my
                human resources background with my self-taught web development
                skills, allowing me to explore creative and practical solutions
                to real-world problems.
              </p>
              <p className="text-lg text-[#ececec] leading-relaxed mb-4">
                I&apos;m passionate about applying my knowledge to improve
                lives, whether by building accessible digital tools, enhancing
                education through technology, or supporting the growth of the
                township economy. I thrive at the intersections of ideas,
                combining innovation and inclusivity to address pressing
                challenges.
              </p>
              <p className="text-lg text-[#ececec] leading-relaxed">
                For me, it&apos;s not just about learning but applying what I
                know to build solutions that matter. I see every project as a
                chance to grow, innovate, and leave a lasting impact. This is my
                journey, and I&apos;m excited to keep pushing boundaries, one
        ...
        <section className="mb-16 pl-2 space-y-3">
          <div>
            <h1 className="text-[28px]  lg:text-[28px] font-bold ">
              Technical{" "}
            </h1>
            <h1 className="text-[28px]  lg:text-[28px] font-bold text-[#a1a0a633]">
              Skills{" "}
            </h1>
          </div>
        ...
        <section className="mb-16 flex flex-col p-4">
